    ...
    <nav className="relative">
      <div className="container mx-auto px-10 pt-8 flex justify-between items-center">
        ...
        <ul className="hidden lg:flex space-x-2">
          ...
          <NavItem path="/fonts-gallery-eng" currentPath={pathname}>
            Browse Fonts
          </NavItem>
          <NavItem path="/handwriting" currentPath={pathname}>
            Handwriting
          </NavItem>
          <NavItem path="/editor" currentPath={pathname}>
            Editor
          </NavItem>
          <li className="text-sm px-4 py-2 rounded-full border-2">
...
const NavItem: React.FC<NavItemProps> = ({ path, currentPath, children }) => {
  ...
  return (
    <li
      className={`text-sm px-4 py-2 rounded-full border-2 ${activeClassName}`}
    >
