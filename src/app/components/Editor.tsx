...
const Editor = () => {
  const [randomText, setRandomText] = useState<string>(
    "Add filler text or click here to start typing."
  );
  ...
  const handleFillerTextAmountChange = (
    event: React.ChangeEvent<HTMLInputElement>
  ) => {
      ...
      <div className="max-w-full mx-auto pb-4">
        <div className="mb-4 flex flex-col sm:flex-row sm:justify-between sm:items-center">
          <div className="mb-2 sm:mb-0 sm:flex items-center">
            <label
              htmlFor="font-size"
              className="font-sans text-xs lg:text-md sm:mx-2"
            >
              Size
            </label>
            <input
          ...
          <div className="sm:flex sm:justify-center items-center">
            ...
            <div className="">
              <button
                ...
                className={` mr-2 px-1 py-1 border rounded-sm ${
                  alignment === "left"
              ...
              >
                <TextAlignLeftIcon
                  color={alignment === "left" ? "#000000" : "#ffffff"}
                />
              </button>
              <button
              ...
              >
                <TextAlignCenterIcon
                  color={alignment === "center" ? "#000000" : "#ffffff"}
                />
              </button>
              <button
                onClick={() => handleAlignmentChange("right")}
                className={`mr-8 px-1 py-1 border rounded-sm ${
                  alignment === "right"
                    ? "bg-gray-200 text-black"
                    : "border-gray-200 text-gray-600"
                }`}
              >
                <TextAlignRightIcon
                  color={alignment === "right" ? "#000000" : "#ffffff"}
                />
              </button>
              <button
                onClick={() => setIsUnderline(!isUnderline)}
                className={`px-1 py-1 border rounded-sm mr-2 ${
                  isUnderline
                    ? "bg-gray-200 text-black"
                    : "border-gray-200 text-gray-600"
                }`}
              >
                <TextUnderlineIcon
                  color={isUnderline ? "#000000" : "#ffffff"}
                />
              </button>
              <button
                onClick={() => setIsItalic(!isItalic)}
                className={`px-1 py-1 mr-8 border rounded-sm ${
                  isItalic
                    ? "bg-gray-200 text-black"
                    : "border-gray-200 text-gray-600"
                }`}
              ...
              <button
                onClick={handleReset}
                className="hover:bg-white hover:text-black hover:border-white border-purpur bg-purpur text-white px-1 py-1 border-2 rounded-full"
              >
                <ResetIcon />
              </button>
            </div>
